...
public class SimpleStockServicesFactoryTest {
	...
	@Test
		...
		isStockServicesFactoryASingleton();
                isStockServicesASingleton();
                recordATrade();
        ...
        private void isStockServicesFactoryASingleton(){
	...
	private void isStockServicesASingleton(){
